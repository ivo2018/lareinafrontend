  ...
  return (
    <div class="Home-Carousel">
      <div class="Home-Carousel__principal">
        <img src="http://www.lareinapinamar.com.ar/img/inicio/2.jpg" />
      </div>
      <div class="Home-Carousel__cards">
        <div class="Home-Carousel__second">
          <p>La Reina Pinamar</p>
          <img src="http://www.lareinapinamar.com.ar/img/inicio/3.jpg" />
          <b>
        ...
        <div class="Home-Carousel__trhee">
          ...
          <img src="http://www.lareinapinamar.com.ar/img/thumb_mayorista.jpg" />
          <b>
